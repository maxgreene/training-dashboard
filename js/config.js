  ...
  plan: {
    ...
    events: [
      ...
      { date: '2026-09-24', type: 'sim', title: 'Petersberg-Segment (Rücken-Check)',
        ...
        protected: true },
      { date: '2026-09-25', type: 'rest', title: 'Kurzurlaub Groningen',
        desc: 'kein Rad (25.-27.09) · Rücken erholt sich, Beine frisch für die Giro-Woche',
        protected: true },
      { date: '2026-09-26', type: 'rest', title: 'Kurzurlaub Groningen',
        desc: 'kein Rad · frei',
        protected: true },
      { date: '2026-09-27', type: 'rest', title: 'Kurzurlaub Groningen',
        desc: 'kein Rad · frei',
        protected: true },
      { date: '2026-09-28', type: 'sim', title: 'Wiedereinstieg + Öffner',
        desc: 'nach 3 Tagen Pause: locker + 3×1 min + 2 Sprints, Beine wecken (nicht flach werden lassen)',
        protected: true },
